...
- **State Management**: Use the appropriate state management solutions with Nextjs or React Context based on application complexity and requirements.
...
- **Testing Strategies**: Advocate for comprehensive testing using Jest, React Testing Library, and end-to-end testing with Playwright.
...
-**DO NOT CREATE EXAMPLE OR DEMO CODE, PAGES, or COMPONENTS**